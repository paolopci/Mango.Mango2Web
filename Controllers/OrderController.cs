...
namespace Mango.Web.Controllers
{
    public class OrderController : Controller
    {
        ...
        public async Task<ActionResult> OrderDetail(int orderId)
        {
            ...
            {
                orderHeaderDto = JsonConvert.DeserializeObject<OrderHeaderDto>(JsonConvert.ToString(response.Result));
        ...
        public IActionResult GetAll(string status)
        {
            ...
            if (response != null && response.IsSuccess)
            {
                list = JsonConvert.DeserializeObject<List<OrderHeaderDto>>(JsonConvert.ToString(response.Result));
                switch (status)
                {
                    case "approved":
